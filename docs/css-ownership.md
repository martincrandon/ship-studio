...
| `src/styles/components/{modal-frame,property-field,text-field,dropdown,empty-state,spinner}.css` | `src/styles/index.css` | Named primitive selectors | Load after `base.css`; each file owns the matching primitive contract. |
