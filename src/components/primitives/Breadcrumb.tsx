...
/** Interactive breadcrumb item. This is a button because Ship Studio uses the
 * breadcrumb to reselect an element in the live preview rather than navigate URLs. */
